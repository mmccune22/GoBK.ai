...
import { buildGuideProfileFindings, buildPreparationFindings } from './preparation.js';

export const SCOPE_NOTICE = 'Educational bankruptcy consultation roadmap. No filing recommendation, Chapter 7 or Chapter 13 eligibility, means test, repayment plan, property protection, waiting-period, or debt discharge determination has been performed.';
...
export function buildFindings(snapshot: Snapshot, validation: Validation): Finding[] {
  ...
  values.push(...buildGuideProfileFindings(validation));
