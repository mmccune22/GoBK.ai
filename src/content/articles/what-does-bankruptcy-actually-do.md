...
If your situation needs collection stopped and debts ended, bankruptcy may be the tool for it. The BK Checkup and the rest of this Library are for figuring out whether it is, which route fits, or whether something short of bankruptcy does the job.
